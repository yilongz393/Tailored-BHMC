...
public:
	//Parameters
	const int NP_I;                 // Number of NPs of type I
	const int NP_II;                // Number of NPs of type II
	const double RADI_I;            // Radius of NP I (nm)
	const double RADI_II;           // Radius of NP II (nm)
